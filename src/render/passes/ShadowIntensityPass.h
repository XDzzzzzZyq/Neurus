...
private:
	...
	std::unique_ptr<ComputeShader> m_pointLightShader;  ///< Point-light cubemap eval (shadow_eval.comp)
	std::unique_ptr<ComputeShader> m_sunLightShader;    ///< Sun-light 2D eval (sun_shadow_eval.comp)
