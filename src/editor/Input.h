...
private:
	...
	// --- Qt key codes for modifier queries (inlined to avoid Qt coupling) ---
	static constexpr int kQtKeyShift   = 0x01000020; // Qt::Key_Shift
	static constexpr int kQtKeyControl = 0x01000021; // Qt::Key_Control
	static constexpr int kQtKeyAlt     = 0x01000023; // Qt::Key_Alt
