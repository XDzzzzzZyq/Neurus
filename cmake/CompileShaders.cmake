...
foreach(SHADER_SRC ${SHADER_SOURCES})
	...
	set(SPV_FILE "${SHADER_OUTPUT_DIR}/${SHADER_NAME}.${SHADER_EXT_NO_DOT}.spv")
	set(HEADER_FILE "${SHADER_OUTPUT_DIR}/${SHADER_NAME}.${SHADER_EXT_NO_DOT}.h")
	...
	add_custom_command(
		...
		DEPENDS ${SHADER_SRC}
		COMMENT "Compiling shader: ${SHADER_NAME}.${SHADER_EXT_NO_DOT}"
	)
	...
	add_custom_command(
		...
		COMMAND ${CMAKE_COMMAND}
			...
			-DARRAY_NAME=${SHADER_NAME}_${SHADER_EXT_NO_DOT}_spv
			-P ${CMAKE_SOURCE_DIR}/cmake/SpvToHeader.cmake
		DEPENDS ${SPV_FILE} ${CMAKE_SOURCE_DIR}/cmake/SpvToHeader.cmake
		COMMENT "Generating shader header: ${SHADER_NAME}.${SHADER_EXT_NO_DOT}.h"
	)
