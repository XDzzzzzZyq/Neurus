...
## Summary
- 982 nodes · 1417 edges · 84 communities (52 shown, 32 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `78dc5fb4`
...
Cohesion: 0.06
Nodes (43): ComputePipelineBuilder, CreateDescriptorSetLayout(), CreateEquirectSampler(), CreatePipeline(), dispatchCompute(), Generate(), IBLPass(), IBLPushConstants (+35 more)

### Community 1 - "Pipeline & Buffer Construction"
Cohesion: 0.14
Nodes (18): GPUBuffer, CreateDescriptorSetLayout(), CreatePipeline(), GetLightSSBO(), LightingPass(), Record(), UploadLights(), WriteDescriptors() (+10 more)
...
Cohesion: 0.06
Nodes (35): array, neurus(), KernelSampleGpu, kMaxKernelSamples, kNoiseEntryCount, NoiseEntryGpu, neurus(), neurus() (+27 more)
...
Cohesion: 0.17
Nodes (29): Format, ImageAspectFlags, ImageData, ImageSubresourceRange, ImageType, ImageUsageFlags, MemoryPropertyFlags, allocateAndBindMemory() (+21 more)
...
Cohesion: 0.09
Nodes (33): ClearValue, DescriptorSetLayoutBuilder, BeginPass(), CreateCameraLayout(), CreatePipeline(), EndPass(), GeometryPass(), Record() (+25 more)
...
Cohesion: 0.09
Nodes (30): AddFace(), ComputeCenter(), ComputeFaceNormals(), ComputeTangents(), GetIndexCount(), GetMeshCenter(), GetMeshName(), GetVertexCount() (+22 more)
...
Cohesion: 0.05
Nodes (45): Camera, CameraUBOData, class, CommandPool, GeometryRenderItem, Mesh, CreateDescriptorSets(), DispatchCompute() (+37 more)
...
## Knowledge Gaps
- **239 isolated node(s):** `Device`, `Pipeline`, `namespace`, `PhysicalDevice`, `Queue` (+234 more)
...
- **Why does `ImageData` connect `Vulkan Image & Pipeline State` to `Render Pass Manager`, `Texture & Mipmap Pipeline`, `Attachment & Render Cache`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `Light` connect `Scene Objects & Property UI` to `Rendering Primitives & Resources`, `Pipeline & Buffer Construction`, `Community 12`, `Camera Controller Events`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **What connects `Device`, `Pipeline`, `namespace` to the rest of the system?**
