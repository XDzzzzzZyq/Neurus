# Graph Report - D:\Projects\Neurus  (2026-07-16)

## Corpus Check
- 87 files · ~2,995 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 599 nodes · 1028 edges · 28 communities (27 shown, 1 thin omitted)
...
7. `Texture` - 18 edges
8. `Application` - 17 edges
9. `Initialize()` - 17 edges
...
### Community 3 - "Swapchain"
Cohesion: 0.09
Nodes (38): DeferredRenderer, Editor, ChangeObjectVisibility(), GenerateIBL(), GetRenderContext(), HandleResize(), Initialize(), OnCameraAdd() (+30 more)

### Community 4 - "Scene & Camera Controllers"
Cohesion: 0.08
Nodes (33): Camera, CameraPushEvent, CameraResizeEvent, CameraRotateEvent, CameraSlideEvent, CameraZoomEvent, CameraController, Init() (+25 more)
...
### Community 7 - "Debug Primitives & Light"
Cohesion: 0.07
Nodes (11): LightType, PointType, SetColor(), SetOpacity(), SetPointType(), Light(), ParseLightName(), SpriteType (+3 more)
...
Cohesion: 0.12
Nodes (16): GetUIContext(), AddCategoryGroup(), EnsureRowPool(), Outliner(), Refresh(), PropertyPanel, BuildHeader(), BuildTransformEditor() (+8 more)

### Community 11 - "Debug Primitives & Light (alt)"
Cohesion: 0.11
Nodes (6): setObjectId(), setShadowEnabled(), CameraProperties, EnvironmentProperties, LightProperties, MeshProperties

### Community 12 - "Buffer Hierarchy"
Cohesion: 0.15
Nodes (14): createBuffer(), findMemoryType(), GPUBuffer(), Map(), StagingBuffer(), Unmap(), Upload(), GPUBuffer (+6 more)

### Community 13 - "Descriptor & Shadow Pipeline (alt)"
Cohesion: 0.18
Nodes (14): createPipeline(), CreateSSBOLayout(), createSSBOResources(), createSunPipeline(), MakeFaceVPs(), ShadowDepthPass(), Allocate(), Build() (+6 more)
...
### Community 16 - "Transform Math"
Cohesion: 0.21
Nodes (8): SetPosition(), GlmSerialization, ComputeModelMatrix(), GetTransformPtr(), SetRotation(), SetScale(), Transform3D(), Transform

### Community 17 - "OutlinerRow"
Cohesion: 0.26
Nodes (11): LoadOutlinerStyle(), OutlinerRow(), setEyeBtnColor(), setObject(), setRenderBtnColor(), setSelectionMode(), setVisibilities(), QIcon (+3 more)

### Community 18 - "Main Window & UI"
Cohesion: 0.27
Nodes (7): UIManager, CreateDocks(), CreateMenus(), LoadLayout(), makePlaceholder(), RestoreDefaultLayout(), UIManager()

### Community 19 - "Vulkan Context"
Cohesion: 0.29
...
### Community 24 - "Buffer Layout"
Cohesion: 0.60
Nodes (4): GetBindingDescription(), GetFormatSize(), GetStride(), BufferLayout

### Community 25 - "Node Graph"
Cohesion: 0.60
Nodes (5): Graph, Connect(), Disconnect(), SocketInT, SocketOutT

### Community 26 - "SyncObjects"
Cohesion: 0.50
Nodes (4): SyncObjects, sync_fence(), sync_semaphore(), device

## Knowledge Gaps
- **36 isolated node(s):** `EditorEvents`, `SelectionMode`, `CameraZoomEvent`, `CameraRotateEvent`, `CameraPushEvent` (+31 more)
...
- **Why does `Editor` connect `Swapchain` to `Scene & Camera Controllers`, `Editor & Context`, `Editor & Property UI`, `Buffer Hierarchy`, `Vulkan Context`?**
  _High betweenness centrality (0.180) - this node is a cross-community bridge._
- **Why does `RenderCache` connect `Descriptor & Shadow Pipeline` to `Render Pipeline & SSAO`, `Image & Barrier System`, `Swapchain`, `Texture & Material`, `Buffer Hierarchy`, `Descriptor & Shadow Pipeline (alt)`?**
  _High betweenness centrality (0.179) - this node is a cross-community bridge._
- **Why does `GeometryPass` connect `Render Pipeline & SSAO` to `Descriptor & Shadow Pipeline`, `Swapchain`, `Shader Compilation`?**
  _High betweenness centrality (0.173) - this node is a cross-community bridge._
- **What connects `EditorEvents`, `SelectionMode`, `CameraZoomEvent` to the rest of the system?**
