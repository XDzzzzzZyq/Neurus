 ...
 * GLM_FORCE_DEPTH_ZERO_TO_ONE 鈫?left-handed view (Vz = +y + 10).
...
protected:
	...
	static constexpr float    kQuadY = -5.f;   // world-space y (quad at Y=-5, 5 units forward from eye 鈥?Z-up)
	...
	static float ExpectedDepth() {
		...
		// GLM_FORCE_DEPTH_ZERO_TO_ONE 鈫?left-handed view: +Z = forward.
