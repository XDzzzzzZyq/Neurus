 ...
 *   - Camera: at (0, 1, 3) looking at origin, FOV=75掳, 256x256
 *
...
// ===========================================================================
// SunMultiShadowIntensity 鈥?per-light readback + statistical verification
// ===========================================================================
...
TEST_F(SunShadowIntensityTest, SunMultiShadowIntensity_VerifyNonZero)
{
	...
	for (size_t li = 0; li < shadowRes.lightUIDs.size(); ++li)
	{
		...
		EXPECT_GT(shadowedCount, 50u)
			...
			<< "expected at least 50 shadowed pixels 鈥?cube should cast a visible shadow on the plane";
		EXPECT_GT(litCount, 100u)
			<< "Sun light " << li << " (UID=" << lightUID << "): "
			<< "expected at least 100 lit pixels 鈥?plane pixels outside the shadow should be lit";
	}
}

// ===========================================================================
// SunMultiShadowIntensity_ReferenceImage 鈥?reference-image regression
// ===========================================================================
